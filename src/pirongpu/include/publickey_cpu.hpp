...
namespace heoncpu
{
    ...
    class Publickey
    {
      ...
      public:
              ...
              coeff_modulus_count_(copy.coeff_modulus_count_)
        {
            ...
            std::memcpy(locations_.data(),
                                copy.locations_.data(),
                                copy.locations_.size() * sizeof(Data64));
        }
    ...
    class MultipartyPublickey : public Publickey
    {
      ...
      public:
        MultipartyPublickey(Parameters& context, const int seed);
