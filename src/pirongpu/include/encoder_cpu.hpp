...
namespace heoncpu
{
    ...
    //                               Plaintext& plain, const cudaStream_t stream);
      ...
      private:
        ...
        // BFV
        std::shared_ptr<std::vector<Modulus64>> plain_modulus_;
        ...
        std::shared_ptr<std::vector<Complex64>> special_fft_roots_table_;
        std::shared_ptr<std::vector<Complex64>> special_ifft_roots_table_;
        std::shared_ptr<std::vector<int>> reverse_order;
