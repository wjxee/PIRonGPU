...
namespace heoncpu
{
    ...
    class Relinkey
    {
      ...
      public:
         ...
         */
        Relinkey(Parameters& context, bool store_in_gpu = true);
         ...
         * key in GPU memory. Default is true.
         */
        Relinkey(Parameters& context, std::vector<Data64>& key,
      ...
      private:
        ...
        std::vector<std::vector<Data64>> device_location_leveled_;

        // store key in host (CPU)
        std::vector<Data64> host_location_;
        std::vector<std::vector<Data64>> host_location_leveled_;
    };
    ...
    class MultipartyRelinkey : public Relinkey
    {
      ...
      public:
        MultipartyRelinkey(Parameters& context, const int seed,
                                    bool store_in_gpu = true);
    ...
    class Galoiskey
    {
      ...
      public:
         ...
         * key in GPU memory. Default is true.
         */
        Galoiskey(Parameters& context, bool store_in_gpu = true);
    ...
    class MultipartyGaloiskey : public Galoiskey
    {
      ...
      public:
        MultipartyGaloiskey(Parameters& context, const int seed,
                                     bool store_in_gpu = true);

        MultipartyGaloiskey(Parameters& context,
    ...
    class Switchkey
    {
      ...
      public:
         ...
         * key in GPU memory. Default is true.
         */
        Switchkey(Parameters& context, bool store_in_gpu = true);
