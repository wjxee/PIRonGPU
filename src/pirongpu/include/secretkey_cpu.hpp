...
namespace heoncpu
{
    ...
    class Secretkey
    {
      ...
      public:
         ...
         */
        Secretkey(Parameters& context, int hamming_weight);
      ...
      private:
        ...
        std::vector<int> secretkey_; // coefficients are in {-1, 0, 1}
        std::vector<Data64> location_; // coefficients are RNS domain
    };
} // namespace heongpu 