...
namespace heoncpu
{
    ...
    HEOperator::HEOperator(Parameters& context, HEEncoder& encoder)
    {
        ...
        new_prime_locations_ = std::vector<int>(prime_loc);
        new_input_locations_ = std::vector<int>(input_loc);
    ...
    //                         [&](Ciphertext& output_)
    //                         {
    //                             std::vector<Data64> output_memory(
    ...
    //     std::vector<Data64> output_memory((3 * n * Q_size_), stream);

    //     std::vector<Data64> temp_mul((4 * n * (bsk_mod_count_ + Q_size_)) +
    ...
    //     std::vector<Data64> output_memory((3 * n * current_decomp_count),
    //                                        stream);
    ...
    // {
    //     int current_decomp_count = Q_size_ - input1.depth_;
    //     std::vector<Data64> output_memory((2 * n * current_decomp_count),
    //                                        stream);
    ...
    //     else
    //     {
    //         std::vector<Data64> temp_plain_mul(n * Q_size_, stream);
    ...
    //     else
    //     {
    //         std::vector<Data64> key_location(relin_key.host_location_, stream);
    //         multiply_accumulate_kernel<<<dim3((n >> 8), Q_prime_size_, 1), 256,
    //                                      0, stream>>>(
    ...
    //     Ciphertext& input1, Relinkey& relin_key, const cudaStream_t stream)
    // {
    //     std::vector<Data64> temp_relin_new((n * d * r_prime) +
    //                                             (2 * n * d_tilda * r_prime) +
    //                                             (2 * n * Q_prime_size_),
    //                                         stream);
    ...
    //     std::vector<Data64> temp_relin_new(
    ...
    //     else
    //     {
    //         std::vector<Data64> key_location(
    ...
    //     std::vector<Data64> temp_rescale(
    ...
    //     std::vector<Data64> temp_mod_drop_(n * Q_size_, stream);
    ...
    //     int current_decomp_count = Q_size_ - input1.depth_;
    //     std::vector<Data64> output_memory(n * (current_decomp_count - 1),
    //                                        stream);
    ...
    //     std::vector<Data64> temp_rotation((2 * n * Q_size_) +
    ...
    //     std::vector<Data64> temp_rotation((2 * n * Q_size_) + (n * Q_size_) +
    //                                            (2 * n * Q_prime_size_ * d) +
    //                                            (2 * n * Q_prime_size_),
    //                                        stream);
    ...
    //     std::vector<Data64> temp_rotation(
    ...
    //     else
    //     {
    //         std::vector<Data64> key_location(galois_key.zero_host_location_,
    //                                           stream);
    //         multiply_accumulate_kernel<<<dim3((n >> 8), Q_prime_size_, 1), 256,
    //                                      0, stream>>>(
    //             temp1_rotation, key_location.data(), temp2_rotation,
    ...
    //     else
    //     {
    //         std::vector<Data64> key_location(switch_key.host_location_,
    //                                           stream);
    //         multiply_accumulate_kernel<<<dim3((n >> 8), Q_prime_size_, 1), 256,
    //                                      0, stream>>>(
    //             temp1_rotation, key_location.data(), temp2_rotation,
    ...
    //     else
    //     {
    //         std::vector<Data64> key_location(conjugate_key.zero_host_location_,
    //                                           stream);
    //         multiply_accumulate_leveled_kernel<<<
    //             dim3((n >> 8), current_rns_mod_count, 1), 256, 0, stream>>>(
    //             temp2_rotation, key_location.data(), temp3_rotation,
    ...
    //     std::vector<Data64> temp(2 * n * Q_size_, stream);
    ...
    //                                        const cudaStream_t stream)
    // {
    //     std::vector<Data64> output_memory(n * Q_size_, stream);
    ...
    //         std::vector<Data64>(plain.plain_size_, stream);
    ...
    //         std::vector<Data64>(cipher_memory_size, stream);
    ...
    //         in.push_back(input);
    //     }
    //     std::vector<Complex64> message_gpu(slot_count_);
    ...
    //                              bool use_all_bases)
    // {
    //     std::vector<heongpu::std::vector<Data64>> result;

    //     int rns_count = use_all_bases ? Q_prime_size_ : Q_size_;

    //     for (int m = 0; m < vandermonde.StoC_piece_; m++)
    //     {
    //         heongpu::std::vector<Data64> temp_encoded(
    ...
    //     Ciphertext& cipher, std::vector<heongpu::std::vector<Data64>>& matrix,
    ...
    //         std::vector<Data64> rotated_result =
    ...
    //     std::vector<Data64> result((2 * current_decomp_count * n1) << n_power,
    ...
    //     heongpu::std::vector<Complex64> V_logn_diagnal(
    ...
    //     for (int i = 0; i < StoC_piece_; i++)
    //     {
    //         heongpu::std::vector<int> diag_index_gpu(
    //             E_splitted_diag_index_gpu_[i]);
    //         heongpu::std::vector<int> input_index_gpu(
    //             E_splitted_input_index_gpu_[i]);
    //         heongpu::std::vector<int> output_index_gpu(
    //             E_splitted_output_index_gpu_[i]);

    //         heongpu::std::vector<Complex64> V_mul((V_matrixs_index_[i].size())
    //                                                << log_num_slots_);
    ...
    //         {
    //             heongpu::std::vector<Complex64> temp_result(
    ...
    //     heongpu::std::vector<Complex64> V_inv_logn_diagnal(
    //         ((3 * log_num_slots_) - 1) << log_num_slots_);
    ...
    //         heongpu::std::vector<Complex64> V_mul(
    ...
    //     {
    //         heongpu::std::vector<Complex64> temp_rotated(
    ...
    //         encoded_constant_1over2_ = std::vector<Data64>(Q_size_ << n_power);
    ...
    //             std::vector<Data64>(Q_size_ << n_power);
    ...
    //         encoded_complex_i_ = std::vector<Data64>(Q_size_ << n_power);
    //         quick_ckks_encoder_constant_complex(
    ...
    //         encoded_constant_1_ = std::vector<Data64>(Q_size_ << n_power);
    //         quick_ckks_encoder_constant_double(
    //             constant_1, encoded_constant_1_.data(), scale_boot_);
    //         HEONGPU_CUDA_CHECK(cudaGetLastError());

    //         double constant_1over6 = 1.0 / 6.0;
    //         encoded_constant_1over6_ = std::vector<Data64>(Q_size_ << n_power);
    //         quick_ckks_encoder_constant_double(
    ...
    //     std::vector<Data64> input_intt_poly(2 * n, options.stream_);
    //     input_storage_manager(
    //         input1,
    //         [&](Ciphertext& input1_)
    //         {
    ...
    //         encoded_constant_one_ = std::vector<Data64>(slot_count_);
    ...
    //         double constant_1 = 1.0;
    //         encoded_constant_one_ = std::vector<Data64>(Q_size_ << n_power);
    //         quick_ckks_encoder_constant_double(
    ...
    //         encoded_constant_1over3_ = std::vector<Data64>(Q_size_ << n_power);
    //         quick_ckks_encoder_constant_double(
    //             constant_1over3_, encoded_constant_1over3_.data(), scale_boot_);
    //         HEONGPU_CUDA_CHECK(cudaGetLastError());

    //         double constant_2over3_ = 2.0 / 3.0;
    //         encoded_constant_2over3_ = std::vector<Data64>(Q_size_ << n_power);
    //         quick_ckks_encoder_constant_double(
    ...
    //         encoded_complex_2over6j_ = std::vector<Data64>(Q_size_ << n_power);
    //         quick_ckks_encoder_constant_complex(
    //             complex_2over6j_, encoded_complex_2over6j_.data(), scale_boot_);
    //         HEONGPU_CUDA_CHECK(cudaGetLastError());

    //         double constant_2over6_ = 1.0 / 3.0;
    //         encoded_constant_2over6_ = std::vector<Data64>(Q_size_ << n_power);
    //         quick_ckks_encoder_constant_double(
